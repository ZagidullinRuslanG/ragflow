...
def migrate_db():
    ...
    alter_db_add_column(migrator, "api_4_conversation", "user_name", CharField(max_length=255, null=True, help_text="display name for external users", index=True))
    alter_db_add_column(migrator, "api_4_conversation", "is_external", BooleanField(default=False, help_text="true if from embedded widget", index=True))
